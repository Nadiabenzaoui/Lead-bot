    ...
    <div className="min-h-screen flex bg-zinc-950 text-zinc-100">
      ...
      <main className="ml-52 flex-1 min-h-screen bg-zinc-950">
        <header className="px-6 py-4 border-b border-zinc-800/80 flex items-center justify-between">
          <div>
            <h1 className="text-sm font-semibold text-zinc-100 tracking-tight">Messages</h1>
        ...
        <div className="p-6">
          <p className="text-xs text-zinc-600">
            La route `/send` existe maintenant en Next. On y migrera le contenu de `SendPage` de l&apos;ancien front.
          </p>
        </div>
      </main>
    </div>
